 ...
 *
 * $Id: clbg.h 48 2008-12-07 23:34:40Z dtrg $
 * $HeadURL: https://cluecc.svn.sourceforge.net/svnroot/cluecc/clue/test/clbg.h $
...
extern int clbgmain(int argc, const char* argv[]);
