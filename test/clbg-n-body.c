 ...
 *
 * $Id: clbg-n-body.c 48 2008-12-07 23:34:40Z dtrg $
 * $HeadURL: https://cluecc.svn.sourceforge.net/svnroot/cluecc/clue/test/clbg-n-body.c $
...
static void advance(int nbodies, struct planet * bodies, double dt)
{
  int i, j;
